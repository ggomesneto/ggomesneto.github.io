...
$(document).on('dblclick', '#aboutMe', function() {
	...
	$(document).on('click', '#right', function() {
        ...
        <span>DURING <STRONG>3 YEARS</STRONG>, I TRAVELLED THROUGH BRAZIL AND THE USA PLAYING POKER. LIFE WAS GOOD, BUT THERE WAS NO FINANCIAL STABILITY. </SPAN><br><span>BUT IF I HAVE NEVER TRIED THIS, I WOULDN'T MEET THE <STRONG>LOVE OF MY LIFE</STRONG></SPAN><br>
        <br>
        <br>
        <br>
        <br>
